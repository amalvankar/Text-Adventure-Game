...
public class TextController : MonoBehaviour {
	...
	void sheets_0() {
		text.text = "You can't believe you sleep in these things. Surely it is  "+
	...
	void lock_0() {
		text.text = "This is one of those button locks.You have no idea what the " + 
					"combination is. You wish you could somewhere see where the dirty "+
					"fingerprints, maybe that would help.\n\n  " +
